...
import { deleteAgenda } from '@/app/(dashboard)/agenda/actions' // Pastikan path ini sesuai lokasi action Anda
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="flex items-center gap-3 w-full">
                <button
                  ...
                  disabled={isDeleting}
                  className="flex-1 px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium rounded-lg transition-colors disabled:opacity-50"
                >
                  Batal
                </button>
                <button
