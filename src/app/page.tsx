...
export default async function PublicPage() {
  ...
  // 3. Fetch Agenda Mendatang (Maksimal 3)
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-poppins selection:bg-blue-200">
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        {/* Hero Section */}
        <div className="text-center mb-12"> {/* Jarak bawah dikurangi agar menyatu dengan carousel */}
            <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4 tracking-tight">Transparansi Keuangan &<br/>Agenda Masjid</h1>
        ...
        <div className="mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6">
                ...
                {events?.length === 0 && (
                    <div className="col-span-3 text-center py-8 bg-slate-50 rounded-lg border border-dashed border-slate-300 text-slate-500">
        ...
        <div className="mt-12 pt-8 border-t border-slate-200 grid md:grid-cols-2 gap-8 text-sm text-slate-500">
            <div>
                ...
                <p>Jl. Jaksa Agung Suprapto No.1, Pesanggrahan, Gempeng, Kec. Bangil, Pasuruan <br/>Kode Pos: 67153</p>
            </div>
            <div className="md:text-right">
                ...
                <p className="mt-1 text-slate-400 text-xs">
                    Dibuat oleh{' '}
                    <a 
                        href="https://github.com/SahrulRamadhanHardiansyah" 
                        target="_blank" 
